...
const _en = {
  ...
  projects: {
    ...
    items: [
      {
        title: 'Bulleyah (Feature Screenplay, 117 pp.)',
        badge: 'In Development',
        badgeBuilding: 'In Development',
        desc: 'Recovering the erased queer identity of 18th-century Sufi poet Bulleh Shah. Five years in development. AI-assisted proof-of-concept visuals built with MidJourney, Stable Diffusion, and Runway. Refuses to translate South Asian queer experience for Western consumption.',
        tech: ['Screenwriting', 'Archival Research', 'Decolonial Aesthetics', 'AI Visuals'],
        link: '',
      },
      {
        ...
        badgeBuilding: '',
        desc: 'A RAG-powered conversational app for Muslims navigating identity within religious frameworks — communities with no institutional support and high risk of harm from generic LLM misinformation. Serving hundreds of queries monthly from users in Pakistan, the UK, and the Gulf.',
      ...
      },
      {
        ...
        badge: 'Active',
        badgeBuilding: '',
        desc: 'Harm reduction community for queer Pakistanis in criminalized environments. Guidance on PrEP access, HIV prevention, and mental health support. Operates where no institutional help exists.',
  ...
  sharing: {
    ...
    cards: [
      ...
      {
        type: 'project',
        title: 'Bulleyah — Feature Screenplay',
        body: '117 pp. Recovering the erased queer identity of 18th-century Sufi poet Bulleh Shah. Five years in development. AI-assisted proof-of-concept visuals.',
      },
      {
        type: 'project',
        title: 'QuranAI — Live RAG App',
        body: 'Serving hundreds of queries monthly from Muslims navigating identity in communities with no institutional support. Live at aiquran.live.',
